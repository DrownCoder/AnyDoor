...
import static com.xuan.android.library.toast.ToastConfig.LONG_DURATION_TIMEOUT;
import static com.xuan.android.library.toast.ToastConfig.SHORT_DURATION_TIMEOUT;
        ...
        if (!isShow) {
            ...
            */
            ...
            try {
                ...
                isShow = true;
                // 添加一个移除吐司的任务
                sendEmptyMessageDelayed(0, mToast.getDuration() == Toast.LENGTH_LONG ? LONG_DURATION_TIMEOUT : SHORT_DURATION_TIMEOUT);
